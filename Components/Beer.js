...
export const Beer = () => {
    ...
    const [beerList, setBeerList] = useState([
        ...
        {
            name: "Staburags",
            image: "https://rimibaltic-res.cloudinary.com/image/upload/b_white,c_fit,f_auto,h_480,q_auto,w_480/d_ecommerce:backend-fallback.png/MAT_1365284_PCE_LV",
            rating: 6,
        },
        {
            name: "Iļguciema medalus",
            image: "https://ilgezeem.lv/wp-content/uploads/2020/10/medalus_kirsu-kanepju-033l-194x300.png",
            rating: 7,
        },
        {
            name: "Guiness",
        ...
        <View >
            ...
            >
                ...
                <View style={modalStyles.centeredView}>
                    <Text style={modalStyles.closeButton} onPress={() => setModalVisible(false)}>X</Text>
                    <View style={modalStyles.modalView}>
                        ...
                        <View style={styles.formContainer}>
                            ...
                            <View style={styles.inputContainer}>
                                ...
                                <TextInput style={styles.input} value={rating} onChangeText={(e) => setRating(e)} />
                            </View>
                        </View>
